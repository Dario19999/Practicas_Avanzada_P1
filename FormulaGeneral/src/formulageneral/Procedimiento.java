...
//Creamos la clase Procedimiento para llevar a cabo la operación.
public class Procedimiento{
    ...
    public Procedimiento(double a, double b, double c){
        this.a = a;
        this.b = b;
        this.c = c;
    }
    
    //Creamos metodo que almacena el procedimiento de la ecuación
